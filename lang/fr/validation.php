...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Ici, vous pouvez spécifier vos messages de validation personnalisés.
    | La convention pour nommer ces lignes est "attribute.rule" par exemple,
    | "email.required" est un message d'erreur pour le champ "email"
    | lorsqu'il est requis. Vous pouvez également spécifier des règles
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Les lignes de langage suivantes sont utilisées pour échanger des noms
    | d'attributs avec quelque chose de plus lisible comme "Adresse e-mail"
